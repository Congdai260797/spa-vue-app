    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
          ...
          <button
            type="submit"
            class="w-full bg-primary text-primary-foreground px-6 py-3 rounded-md hover:bg-primary/90 transition-colors"
        ...
        <div class="space-y-6">
          <div class="flex items-start">
            ...
            <div class="ml-3">
              ...
              <p class="text-gray-600">123 Web Dev Street, Tech City, 12345</p>
            </div>
          </div>
