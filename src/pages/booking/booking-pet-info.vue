...
<template>
  <div class="w-full flex justify-between">
    <div class="input-section flex-grow">
      ...
      <div class="pet-type-selection mb-4">
        ...
        <p class="text-red-500 p-1" v-if="!bookingPetStore.petType && bookingPetStore.submitStatus">
          Vui lòng chọn một trong các loại thú cưng.
        </p>
      </div>
      ...
      <div class="pet-serv">
        ...
        <p
          ...
          v-if="!bookingPetStore.serviceType && bookingPetStore.submitStatus"
        >
          Vui lòng chọn dịch vụ thú cưng.
        </p>
      </div>
